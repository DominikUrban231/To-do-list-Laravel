                    ...
                    @if ($history->count() > 0)
                        <ol class="relative border-l border-gray-300 dark:border-gray-700">
                            @foreach ($history as $record)
                                <li class="mb-6 ml-6">
                                    <div class="flex items-center justify-center m-6 w-6 h-6 bg-blue-100 rounded-full  ring-8 ring-white dark:ring-gray-800 dark:bg-blue-900">
                                    ...
                                    <div class="p-4 m-6 bg-white dark:bg-gray-700 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600">
